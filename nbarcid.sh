...
while read -r GENOME
  do
    ...
    hmmsearch -E .001 --domE .001 --tblout $DIR/"$PEP"_gennbs.tbl  $MOTIF $PEPSEQ
    ...
    hmmsearch -E .001 --domE .001 --tblout $DIR/"$PEP"_specnbs.tbl  "$PEP"_"$MOT".hmm $PEPSEQ
...
while read -r GENOME
  do
    ...
    PEP=${GENOME:0:5}
    #Search protien sequences for more matches using species specific motif
    hmmsearch -E .001 --domE .001 --tblout $DIR/"$PEP"_combinedgennbs.tbl  combinedgennbs_cuc.hmm $PEPSEQ
...
while read -r GENOME
  do
    ...
    PEP=${GENOME:0:5}
    #Search protien sequences for more matches using species specific motif
    hmmsearch -E .001 --domE .001 --tblout $DIR/"$PEP"_combinedspecnbs.tbl  combinedspecnbs_cuc.hmm $PEPSEQ
